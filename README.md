...
[▶ 点击在线播放完整操作视频（2分51秒，含中文解说）](https://jasmine20260110.github.io/opc-positioning-miniapp-public/demo/)

若播放页暂时无法打开，可[直接下载解说版 MP4 视频](https://raw.githubusercontent.com/jasmine20260110/opc-positioning-miniapp-public/main/demo/opc-demo-commentary.mp4)。

视频展示从定位问答、证据提取、候选路线比较到 7 天行动计划的完整流程。画面使用虚构演示数据，并包含中文解说。
