...
[▶ 点击在线播放完整操作视频（4分39秒，无声）](https://jasmine20260110.github.io/opc-positioning-miniapp-public/demo/)

若播放页暂时无法打开，可[直接下载 MP4 视频](https://raw.githubusercontent.com/jasmine20260110/opc-positioning-miniapp-public/main/demo/opc-demo.mp4)。

视频展示从定位问答、证据提取、候选路线比较到 7 天行动计划的完整流程。画面使用演示数据，公开版本已移除音轨、录屏通知和原始设备描述元数据。
